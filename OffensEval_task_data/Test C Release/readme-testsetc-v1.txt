...
The file testset-taskb.tsv contains 213 unlabeled tweets. This is a sub-set of the complete dataset containing ONLY the tweets with gold label OFF in sub-task A and TIN in sub-task B.

You are required to upload your sub-task C predictions for each of the 213 instances to CodaLab by no later than 31 Jan 2019 (23:59 UTC).
