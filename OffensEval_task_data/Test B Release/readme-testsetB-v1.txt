...
Test data - Sub-task B
v 1.0: January 22 2019
...
The file testset-taskb.tsv contains 240 unlabeled tweets. This is a sub-set of the complete dataset containing ONLY the tweets with gold label OFF in sub-task A.

You are required to upload your sub-task B predictions for each of the 240 instances to CodaLab by no later than 24 Jan 2019 (23:59 UTC).
...
semeval-2019-task-6@googlegroups.com (general mailing list)
semeval-2019-task-6-organizers@googlegroups.com (organizer's mailing list)
The task organizer responsible for the mailing lists is Preslav Nakov.